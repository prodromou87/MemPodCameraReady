...
also shows no paths between memory channels.}

\remark{Also still confused why if you're assuming 1 HBM to 8 DDR pages,
why we keep showing 2 HBM MCs and 1 DDR.}
...
\remark{62 bits sounds like way too many}.
...
\remark{This whole section is pretty mysterious to me.  
First, it starts talking about memory channels etc. but then, say, in the
HMA section it is talking about management of counters being decentralized.
At this point, I have no idea what this section is even about.}

\remark{Part of the confusion is that it is not clear what the cost is of
having the management of the counters centralized. Not much I don't think.
So what is the distinction that this section is trying to make, and does
it matter?} 

\remark{Frankly, this whole section would be a lot clearer if this
subsection was just eliminated.}
...
\remark{I don't see the point of pointing out the cpu can go on and execute
5 non-memory operations, when migrations will take forever.}
...
\remark{these costs are not that hard to estimate -- we just haven't done
the work to do so.  You'll get crucified saying things like this.}
...
\remark{This section is titled ``Migration datapath''.  Why are we talking
about MEA counters and hot page identification?  I'm really confused again...}
...
\remark{I don't believe I saw those ``alternative approaches'' mentioned.}
