...
\remark{This is a weird and convoluted comparison -- drop it. ``Compared to the results obtained with a non-overclocked memory, HMA demostrated the worse scalability, improving its average AMMAT by 18\%. TLM was improved by 30.5\%, THM by 33\% and MemPod by 35\%.''}
